...
Markets are said to dislike political instability. We show that this is not necessarily always the case, as unexpected changes in ruler can give markets a boost when a new regime is expected to offer a more pro-business environment than the previous one. 
...
\subsection{Additional graphical depictions of individual events}

\begin{figure}[!htb]
\includegraphics{../figs/venezuela_coup_attempt_1992.pdf}
